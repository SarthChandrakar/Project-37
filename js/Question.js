class Question {
  ...
  display() {
    this.title.html("Animal Quiz Game");
    this.title.position(350, 0);

    this.question.html(
      "Question:- Which is the largest animal on our planet? "
    );
    this.question.position(150, 80);
    this.option1.html("1: Elephant ");
    this.option1.position(150, 100);
    this.option2.html("2: Blue Whale ");
    this.option2.position(150, 120);
    this.option3.html("3: Giraffe ");
    this.option3.position(150, 140);
    this.option4.html("4: Fin Whale");
